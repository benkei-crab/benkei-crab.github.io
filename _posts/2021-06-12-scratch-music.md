...
<img src="/assets/images/twinkle_blocks01.png" alt="the first program" width="98" height="741">
...
<img src="/assets/images/twinkle_blocks02.png" alt="define blocks" width="100" height="117">

このように定義ブロックを使うとやろうとしていることをわかりやすく書けます。
今回のように繰り返しの多い場合には、使用ブロック数も45から30へとだいぶ減りました。

### 移調できるプログラム
「きらきら星」をもっと高い音で演奏したいとします。
先ほどの楽譜では、この曲はハ長調(C dur)で演奏されます。つまり、ド(C、ハ)から始まってドドソソララソ・・・(60, 60, 67, 67, 69, 69, 67, ...)と続くわけです。これを例えばソ(G、ト)から始めるにはどうすればよいでしょうか?ソから始める場合には、歌ったり、()の音符を()拍鳴らすブロックで確かめてみるとソソレレミミレ・・・(67, 67, 74, 74, 76, 76, 74, ...)ですね。表にまとめてみました。一番下の行はドから始まる曲とソから始まる曲の音の高さの差です。どれも7ですね。
...
このように全体に平行移動することを移調と呼びます。ソ(G, ト, 67)から始まる曲はト長調です。
